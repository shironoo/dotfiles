...
(setq load-path
	...
	(expand-file-name "~/.emacs.d/elisp/emacs-deferred/")
	(expand-file-name "~/.emacs.d/elisp/emacs-epc/")
	(expand-file-name "~/.emacs.d/elisp/emacs-jedi/")
	(expand-file-name "~/.emacs.d/elisp/jedi/")
	(expand-file-name "~/.emacs.d/elisp/python-epc/")
	(expand-file-name "~/.emacs.d/elisp/emacs-ctable/")
        )
       load-path))
...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((codig . utf-8) (TeX-master . "../graduation_thesis") (TeX-master . "t") (TeX-master . "graduation_thesis")))))
(custom-set-faces
